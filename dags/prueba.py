...
def extract_data(url):
    try:
        ...
        df.to_csv(r"airflow\data\output.csv",index=False)
        return "Success"
    except:
...
def send_mail():
    ...
    try:
        ...
        asunto = 'Raul_Higuera_ prueba_finalizada'
        mensaje = 'Hola buenas tardes, ya termine la prueba. El link del repositorio es este https://github.com/raulhiguerac/prueba_foodlogy.git\
...
with DAG(
    ...
    transform_data_task = PythonOperator(
        ...
        op_kwargs={
            "src_file": r"airflow\data\output.csv",
        },
        dag=dag
    )
